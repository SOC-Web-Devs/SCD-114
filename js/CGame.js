function CGame(oData){
    ...
    this._rouletteAnimEnded =async function(){
      ...
      //  var expo = person * 1000000000000000000;
        ...
        let optionss = {
          contractAddress: "0xB65fbEfE1c68578e376729D6fCC710959FAfad9B", //token Adress
          ...
          params: {
            token: "0x337610d27c682E347C9cD60BD4b3b107C9d34dDd", // game smart contract address
            number: number,
            betType: betType,
            betAmount: _am
   ...
   var tokenAddress ="0x401D983FC3EA9B23D2f6014920b0dE66D76b5b27";
    ...
    this.onExit =async function(){
        ...
        // await Moralis.enableWeb3();
        // var expo = person * 1000000000000000000;
        // var _am = Moralis.Units.Token(expo, "9");
        // let optionss = {
        //   contractAddress: "0x401D983FC3EA9B23D2f6014920b0dE66D76b5b27", //token Adress
        //   functionName: "placeBet",
        //   abi: [
        //     {
        //       inputs: [
        ...
        //   ],
        //   params: {
        //     token: "0x401D983FC3EA9B23D2f6014920b0dE66D76b5b27", // game smart contract address
        //     number: number,
        //     betType: bettype,
        //     betAmount: betAmount
        //      // modal value (0.4 * 1e18)

...
window.localStorage.getItem('dml');
window.localStorage.getItem('bls');

var dta = window.localStorage.getItem('user');
var dml = window.localStorage.getItem('dml');
var bls = window.localStorage.getItem('bls');
...
function CGame(oData) {
    ...
    this._rouletteAnimEnded = async function () {
        ...
        if (oWins.mc) {
            ...
            var _am = Moralis.Units.Token(person, dml);
            ...
            let optionss = {
                ...
                params: {
                    token: dta, // game smart contract address
                    number: number,
                    betType: betType,
                    betAmount: _am
            ...
            var _am = Moralis.Units.Token(person, dml);
            let optionss = {
                contractAddress: "0x776Bb2a06a2C9656c2d45F60A80695ce549f1457", //game contract adress
                functionName: "placeBet",
                abi: [
                    {
                        inputs: [
